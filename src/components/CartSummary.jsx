...
const CartSummary = () => {
  return (
    <div className="bg-white h-fit rounded-md row-span-1 md:col-span-1 border border-gray-200 shadow-sm p-3 mb-10">
      <h3 className="text-gray-900 font-semibold text-xl pb-3">Order Summary</h3>
      <div className="details">
        ...
        <div className="flex justify-between items-center border-t border-gray-200 py-3">
          ...
          <p className="text-gray-900">$548.95</p>
        </div>
        <div className="flex justify-between items-center border-t border-gray-200 py-3">
          <h4 className="text-gray-600 text-xl font-semibold">Total</h4>
          <p className="text-gray-900 font-semibold">$548.95</p>
        </div>
        <button className="bg-indigo-500 text-white opacity-50 cursor-not-allowed px-4 py-2 rounded-md shadow-sm">Checkout</button>
      </div>
    </div>
  );
};
